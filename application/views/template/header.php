...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="<?php echo base_url();?>/assets/font-awesome-4.4.0/css/font-awesome.min.css" />
            ...
            <div class="container-fluid">
                <div class="navbar-inner">
                    <div class="navbar-header">
                        ...
                        <a class="navbar-brand">UTM BAZAAR</a>
                    </div>
                    <div class="collapse navbar-collapse" id="pageNavi">
                        ...
                        <ul class="nav navbar-nav navbar-right">
                            ...
                            if(!isset($username)){
                                ...
                                echo "<a href='".base_url()."account/logout' class='header'><span class='fa fa-sign-out'></span> Logout</a>";
                            }
                            ?>
                        </ul>
                    </div>
